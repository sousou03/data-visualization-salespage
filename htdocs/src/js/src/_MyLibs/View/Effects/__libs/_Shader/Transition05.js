...
(function(){
  ...
  Transition05.prototype = {
    ...
    getVs: function(){
      var self = this;
      return $.get('./ff15/royal/gallery2018/assets/js/_devjs/src/Display/Motion/Shader/Transition05.vs', function(data){
        self.vs = data;
      });
    },
    ...
    getFs: function(){
      var self = this;
      return $.get('./ff15/royal/gallery2018/assets/js/_devjs/src/Display/Motion/Shader/Transition05.fs', function(data){
        self.fs = data;
      });
    },
