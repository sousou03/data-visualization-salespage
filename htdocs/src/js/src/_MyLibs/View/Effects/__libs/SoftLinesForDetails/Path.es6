...
export default class Path {
    ...
    setPoint5Corner() {
        ...
        var startPoint = new Point(720, 100);
        ...
        var endPoint = new Point(605, 106);
    ...
    updatePos () {
        ...
        for(var i = 0; i < pts.length; i++){
            ...
            pts[Math.floor(this.num/4*1)].vel = 0; // startpoint
            pts[Math.floor(this.num/4*2)].vel = 0; // startpoint
            pts[Math.floor(this.num/4*3)].vel = 0; // startpoint
    ...
    setCircle (xPos, yPos, strength, radius){
        ...
        for(var i = 0; i < this.points.length; i++){
            ...
            if(dis < radius){
                ...
                if (i==0 || i == Math.floor(this.num/4*1) || i == Math.floor(this.num/4*2)　|| i == Math.floor(this.num/4*3)) return;
