...
(function(){
  ...
  Transition03.prototype = {
    ...
    getVs: function(){
      var self = this;
      return $.get('./ff15/royal/gallery2018/assets/js/_devjs/src/Display/Motion/Shader/Transition03.vs', function(data){
        self.vs = data;
      });
    },
    ...
    getFs: function(){
      var self = this;
      return $.get('./ff15/royal/gallery2018/assets/js/_devjs/src/Display/Motion/Shader/Transition03.fs', function(data){
        self.fs = data;
      });
    },
