  ...
  setCenter(val) {
    ...
    for (var i = 0; i < this.len; i++) {
      ...
      if (x < c01 && x >= c02) {
        ...
        TweenMax.to(this, 0.3, {tarBaseX: center,tarX: center,ease: Power4.easeOut});
    ...
    if (x >= this.centerMidList[0]) {
      ...
      TweenMax.to(this, 0.3, {tarBaseX: this.edgeL,tarX: this.edgeL,ease: Power4.easeOut});
    ...
    if (x < this.centerMidList[this.len-1]) {
      ...
      TweenMax.to(this, 0.3, {tarBaseX: this.edgeR,tarX: this.edgeR,ease: Power4.easeOut});
